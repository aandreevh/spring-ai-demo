...
public class McpClientConfiguration {
  ...
  public List<ToolCallback> fileSystemTools(final McpJsonMapper mapper,
    ...
    final StdioClientTransport transport = new StdioClientTransport(
        new ServerParameters.Builder("npx") /*TODO: requires npx installation (explain why npx)n*/
            .args("-y",
                "@modelcontextprotocol/server-filesystem", //TODO: explain tool to interact with file system
                directory)/*TODO: Add directory to manage*/
            .build(), mapper);
